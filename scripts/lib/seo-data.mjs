...
const HUB_SECTIONS = [
    ...
    { id: 'experiences', title: 'Southern Africa Travel Experiences', description: 'Discover safari, nature, culture, food, coast, adventure, and self-drive experiences across Southern Africa.', priority: '0.7' },
    { id: 'cultures', title: 'Cultures of Southern Africa', description: 'An introduction to the communities, traditions, languages, and living heritage travellers encounter across Southern Africa.', priority: '0.65' },
    ...
    { id: 'news', title: 'Southern Africa Travel News', description: 'Planning updates, seasonal travel information, route news, and practical developments for Southern Africa travellers.', priority: '0.65' },
    ...
    { id: 'events', title: 'Southern Africa Events Calendar', description: 'Explore major festivals, cultural events, races, shows, and seasonal highlights across Southern Africa.', priority: '0.65' },
