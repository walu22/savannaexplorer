...
export const NAV_HUB_TABS = [
    ...
    { href: '/plan#plan/documents', label: 'Visa & documents' },
    { href: '/plan#plan/on-the-go', label: 'On the trip' },
    { href: '/plan#plan/when', label: 'When to go' },
];
...
export const NAV_JOURNEY_GROUPS = [
    {
        ...
        items: [
            ...
            { href: '/gastronomy', label: 'Food & markets' },
        ],
    },
    {
        id: 'plan-trip',
        label: 'Plan trip',
        items: [
            { href: '/my-safari', label: 'My Safari' },
            { href: '/routes', label: 'Route Explorer' },
            { href: '/routes#journey-composer', label: 'Multi-country builder' },
