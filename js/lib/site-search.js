...
const PRACTICAL_PAGES = [
    ...
    { id: 'events', title: 'Events and seasonal planner', summary: 'Match source-checked festivals and seasonal wildlife highlights to your travel dates.', href: '/events', keywords: ['event', 'festival', 'calendar', 'dates', 'wildlife season'] },
    { id: 'travel-updates', title: 'Verified travel updates', summary: 'Review current source-linked entry and event changes before your trip.', href: '/news', keywords: ['news', 'update', 'visa change', 'entry rule', 'event change', 'verified'] },
    { id: 'campsites', title: 'Campsite and overlander planner', summary: 'Compare reviewed camping options by road access, vehicle needs, facilities and booking source.', href: '/campsites', keywords: ['camp', 'campsite', 'camping', 'overland', '4x4', 'tent', 'caravan', 'stay'] },
