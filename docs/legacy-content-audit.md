...
Each public section must help a traveller discover, decide, prepare, act, or stay safe. Content should be specific, traceable where facts can change, respectful, and distinct from stronger tools elsewhere on the site.

## Decisions

| Section | Decision | Reason / next action |
| --- | --- | --- |
| Route Explorer, My Safari, destinations, travel tools | Keep and deepen | These are the core traveller journey. |
...
| Ticker, generic facts, old plan-trip and trust strips | Retire from public output | Decorative or duplicated legacy blocks; the production homepage already excludes them. |
