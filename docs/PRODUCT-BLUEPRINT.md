...
2. **Editorial freshness dashboard (evidence capture implemented):** visa, border, park fee, emergency and travel-advisory data feed a local review queue; all 18 visa records, nine emergency-contact records, nine country advisory records, 27 park records and 30 border records now include record-level official-source evidence. Add individual approval ownership, change history and automated link checks next.
